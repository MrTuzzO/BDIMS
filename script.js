...
//     // Perform character stuffing using regular expression
//     const stuffedData = data.replace(new RegExp(flag, 'g'), esc + flag)
...
//     // Perform character destuffing using regular expression
//     const destuffedData = data.replace(new RegExp(esc + esc, 'g'), esc)
//         .replace(new RegExp(esc + flag, 'g'), flag);
